...
func (x *Container) GetOrgin() string {
	if x != nil {
		return x.Orgin
	}
	return ""
...
var file_proto_consignment_consignment_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x22, 0x0c, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x6b, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x05, 0x6f, 0x72, 0x67, 0x69, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6f, 0x72,
	0x67, 0x69, 0x6e, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x04,
...
var file_proto_consignment_consignment_proto_goTypes = []interface{}{
	(*GetRequest)(nil),  // 0: consignment.GetRequest
...
var file_proto_consignment_consignment_proto_depIdxs = []int32{
	...
	1, // 1: consignment.Response.consignment:type_name -> consignment.Consignment
	1, // 2: consignment.Response.consignments:type_name -> consignment.Consignment
	1, // 3: consignment.ShippingService.CreateConsignment:input_type -> consignment.Consignment
	0, // 4: consignment.ShippingService.GetConsignments:input_type -> consignment.GetRequest
